...
public class WifiStateView extends AppCompatImageView {
    ...
    private static class WifiHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case LEVEL_1:
                    wifiStateView.setImageResource(R.drawable.ic_wifi_1);
                    break;
                case LEVEL_2:
                    wifiStateView.setImageResource(R.drawable.ic_wifi_2);
                    break;
                case LEVEL_3:
                    wifiStateView.setImageResource(R.drawable.ic_wifi_3);
                    break;
                case LEVEL_4:
                    wifiStateView.setImageResource(R.drawable.ic_wifi_4);
                    break;
                case LEVEL_NONE:
                default:
                    wifiStateView.setImageResource(R.drawable.ic_wifi_0);
                    break;
            }
        }
    }

...
public class SpanUtils {
     ...
     * @return {@link Builder}
     */
    public static Builder init(CharSequence text) {
    ...
    public static class Builder {
        ...
        public Builder setReplacementSpan(ReplacementSpan replacementSpan) {
        ...
        private void setSpan() {
            ...
            if (size != -1) {
                mBuilder.setSpan(new AbsoluteSizeSpan(ScreenInfo.toPix(size)), start, end, flag);
                size = -1;
            }
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(MyApplication.context, bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                } else if (imageIsDrawable) {
                    mBuilder.setSpan(new CustomImageSpan(drawable), start, end, flag);
                    drawable = null;
                    imageIsDrawable = false;
                } else if (imageIsUri) {
                    mBuilder.setSpan(new CustomImageSpan(MyApplication.context, uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new CustomImageSpan(MyApplication.context, resourceId), start, end, flag);
                    resourceId = 0;
            ...
            if (replacementSpan != null) {
                mBuilder.setSpan(replacementSpan, start, end, flag);

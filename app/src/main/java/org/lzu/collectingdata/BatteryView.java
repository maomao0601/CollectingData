...
public class BatteryView extends View {
    ...
    private int mWidth = 150;    //总长
    private int mHeight = 64;   //总高
    private int mHeadWidth = 18;
    private int mHeadHeight = 30;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint1.setColor(getResources().getColor(R.color.color_bar_bg));
        ...
        if (mIsCharging) {
            ...
            if (mPower < 0.15) {
                ...
                paint.setColor(getResources().getColor(R.color.color_bar_bg));
            }
        }
